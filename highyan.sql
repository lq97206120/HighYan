...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1000000010 ;
...
CREATE TABLE IF NOT EXISTS `hy_memb` (
  ...
  `mhigh` varchar(8) CHARACTER SET utf8 NOT NULL,
  `mweight` varchar(8) CHARACTER SET utf8 NOT NULL,
  `mmail` varchar(20) CHARACTER SET utf8 NOT NULL,
  `mwechat` varchar(20) CHARACTER SET utf8 NOT NULL,
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1000000047 ;
