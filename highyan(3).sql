...
CREATE TABLE IF NOT EXISTS `hy_example` (
  `eid` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `ename` varchar(20) NOT NULL,
  `ehead` varchar(800) NOT NULL DEFAULT '<p><img title="1457682067348137.gif" alt="touxiang.gif" src="/HighYan/Uploads/image/20160311/1457682067348137.gif"/></p>',
  `emarryclass` varchar(20) NOT NULL,
  `ephoto1` text NOT NULL,
  `ephoto2` text NOT NULL,
  `ephoto3` text NOT NULL,
  `ephoto4` text NOT NULL,
  PRIMARY KEY (`eid`)
...
INSERT INTO `hy_example` (`eid`, `ename`, `ehead`, `emarryclass`, `ephoto1`, `ephoto2`, `ephoto3`, `ephoto4`) VALUES
(1, '葫芦娃', '<p><img title="1457682067348137.gif" alt="touxiang.gif" src="/HighYan/Uploads/image/20160311/1457682067348137.gif"/></p>', '欧式婚礼', '', '', '', ''),
(2, '', '<p>1</p>', '', '', '', '', ''),
(3, '卡尔', '<p><img title="1457682678435934.gif" alt="touxiang.gif" src="/HighYan/Uploads/image/20160311/1457682678435934.gif"/></p>', '中式婚礼', '<p><img title="1457682693940482.gif" alt="index_cpxl.gif" src="/HighYan/Uploads/image/20160311/1457682693940482.gif"/></p>', '', '', ''),
(4, '默认头像', '', '顶顶顶', '', '', '', ''),
(5, '打发', '', '', '', '', '', ''),
(6, '1212', '<p><img title="1457682067348137.gif" alt="touxiang.gif" src="/HighYan/Uploads/image/20160311/1457682067348137.gif"/></p>', '', '', '', '', ''),
(8, 'test1', '<p><img title="1457682067348137.gif" alt="touxiang.gif" src="/HighYan/Uploads/image/20160311/1457682067348137.gif"/></p>', '', '', '', '', ''),
(9, 'test2x', '<p><img title="1457682067348137.gif" alt="touxiang.gif" src="/HighYan/Uploads/image/20160311/1457682067348137.gif"/></p>', '古典式', '', '<p><img title="1457685278822981.gif" alt="index_cpxl.gif" src="/HighYan/Uploads/image/20160311/1457685278822981.gif"/></p>', '<p>x</p>', '<p>x</p>');
...
(127, 'example', '优秀案例', 1, NULL, 1, 18, 3),
(128, 'addexample', '添加案例', 1, NULL, 1, 18, 3),
(129, 'addexamplehandle', '添加案例处理函数', 1, NULL, 1, 18, 3),
(130, 'editexample', '编辑案例', 1, NULL, 1, 18, 3),
(131, 'editexamplehandle', '编辑案例处理函数', 1, NULL, 1, 18, 3),
(132, 'deleteexample', '删除案例', 1, NULL, 1, 18, 3);
...
(35, '100001', 'tdzbz', 'e10adc3949ba59abbe56e057f20f883e', '13917377764 135', 0, '0000-00-00', '2015-12-04', 1, 1457685256, '10.199.154.201'),
